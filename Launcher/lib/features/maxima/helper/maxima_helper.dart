...
class MaximaHelper {
  ...
  static Future<MaximaGameInstance> startGameViaCli({
    ...
    // Custom Proton carries over automatically: the CLI now shares the
    // launcher's maxima-lib (linux-port-patches) and reads the same
    // ~/.local/share/maxima/custom_proton_path sidecar, so no plumbing here.
